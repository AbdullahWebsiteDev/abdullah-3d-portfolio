...
const About = () => {
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText("abdullahaliu490@gmail.com");
    setHasCopied(true);
    setTimeout(() => {
      setHasCopied(false);
    }, 2000);
          ...
          <div className="grid-container">
            ...
            <div>
              ...
              <p className="grid-subtext">
                with 3+ years of experience, I honed my skills in frontend and
        ...
        <div className="col-span-1 xl:row-span-4">
          <div className="grid-container">
            ...
            <div>
              ...
              <p className="grid-subtext">
                I&apos;m based in Kotri Hydrabad, Pakistan and open to remote
                work worldwide.
              </p>
            ...
            <div className="space-y-2">
              ...
              <div className="copy-container" onClick={handleCopy}>
                <img
                  ...
                  alt="copy"
                />
                <p className="text-2xl font-medium text-white md:text-xl text-gray_gradient">
                  abdullahaliu490@gmail.com
                </p>
              </div>
            </div>
          </div>
